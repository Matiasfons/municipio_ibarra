  ...
  return (
    <div className="flex min-h-screen w-full flex-col bg-muted/40">
      ...
      <div className="flex flex-1 gap-4 sm:py-4 sm:pl-14">
          ...
          <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
            <TooltipProvider>
              <Link
                ...
                prefetch={false}
              >
                <FlagIcon className="h-4 w-4 transition-all group-hover:scale-110" />
                <span className="sr-only">Government Finance</span>
              </Link>
              <Tooltip>
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 overscroll-contain">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">$39,876.54</div>
                <p className="text-xs text-muted-foreground">+15.3% from last year</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium">Budget Surplus</CardTitle>
                <DollarSignIcon className="w-4 h-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">$5,355.35</div>
                <p className="text-xs text-muted-foreground">+40.2% from last year</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Allocation of funds</CardDescription>
              </CardHeader>
              <CardContent>
                <PiechartcustomChart className="aspect-square" />
              </CardContent>
